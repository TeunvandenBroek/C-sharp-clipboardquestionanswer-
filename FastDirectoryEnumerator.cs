...
public class FileData
{
    ...
    /// <param name="findData">The findData<see cref="WIN32_FIND_DATA"/></param>
    ...
    /// </summary>
    /// <param name="high">The high<see cref="uint"/></param>
    /// <param name="low">The low<see cref="uint"/></param>
...
public static class FastDirectoryEnumerator
{
    ...
    /// <returns>The <see cref="IEnumerable{FileData}"/></returns>
    ...
    /// <param name="path">The path to search.</param>
    /// <param name="searchPattern">The search string to match against files in the path.</param>
    /// <param name="searchOption">The searchOption<see cref="SearchOption"/></param>
    /// <returns>The <see cref="IEnumerable{FileData}"/></returns>
    ...
    /// <param name="searchPattern">The search string to match against files in the path.</param>
    /// <param name="searchOption">The searchOption<see cref="SearchOption"/></param>
    /// <returns>The <see cref="FileData[]"/></returns>
    ...
    private class FileEnumerable : IEnumerable<FileData>
    {
        ...
        /// </summary>
        /// <returns>The <see cref="IEnumerator{FileData}"/></returns>
    ...
    private class FileEnumerator : IEnumerator<FileData>
    {
        ...
        /// <param name="data">The data<see cref="WIN32_FIND_DATA"/></param>
        /// <returns>The <see cref="SafeFindHandle"/></returns>
        ...
        /// The FindNextFile
        /// </summary>
        /// <param name="hndFindFile">The hndFindFile<see cref="SafeFindHandle"/></param>
        /// <param name="lpFindFileData">The lpFindFileData<see cref="WIN32_FIND_DATA"/></param>
        /// <returns>The <see cref="bool"/></returns>
        [DllImport("kernel32.dll", CharSet = CharSet.Auto, SetLastError = true)]
